...
// Fetch user profile — fires all 4 table queries in parallel,
// returns whichever one finds a match. Only 1 round-trip latency
// instead of 2 (role lookup + profile lookup) sequential calls.
