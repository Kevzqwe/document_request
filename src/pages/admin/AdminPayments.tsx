            ...
            <>
                    ...
                    <TableRow key={p.payment_id}>
                      ...
                      <TableCell>
                        <div className="flex flex-wrap gap-1">
                          {p.documents.length > 0 ? p.documents.map((d, i) => (
                            <Badge key={i} variant="outline" className="text-xs whitespace-nowrap">{d.document_type}</Badge>
                          )) : '—'}
                        </div>
                      </TableCell>
                      ...
                      <TableCell>
                        <Badge variant={statusVariant(p.payment_status)} className="capitalize">{p.payment_status}</Badge>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell className="text-sm">{p.paid_at ? format(new Date(p.paid_at), 'MMM d, yyyy h:mm a') : '—'}</TableCell>
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between mt-4">
                  <p className="text-sm text-muted-foreground">Page {currentPage} of {totalPages} ({filtered.length} records)</p>
